run_game: main.cpp select_character.cpp Character.cpp generate_random_array.cpp check_input.cpp opponent_array.cpp ready.cpp next_round.cpp Move.cpp move_functions.cpp
	clear
	g++ main.cpp select_character.cpp check_input.cpp Character.cpp generate_random_array.cpp opponent_array.cpp ready.cpp next_round.cpp Move.cpp move_functions.cpp -o check_intro
	./run_game
