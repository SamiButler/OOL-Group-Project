...
check_intro: main.cpp select_character.cpp Character.cpp generate_random_array.cpp Move.cpp check_input.cpp
	clang++ main.cpp select_character.cpp check_input.cpp Character.cpp generate_random_array.cpp Move.cpp -o check_intro
	./check_intro
