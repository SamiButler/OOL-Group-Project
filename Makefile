...
check_intro: main.cpp select_character.cpp Character.cpp generate_random_array.cpp
	clang++ main.cpp select_character.cpp Character.cpp generate_random_array.cpp -o check_intro
	./check_intro
